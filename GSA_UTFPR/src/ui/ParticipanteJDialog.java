 ...
 */
public class ParticipanteJDialog extends javax.swing.JDialog {

    boolean addRecord;

    /**
     * Creates new form ParticipanteJDialog
     */
    public ParticipanteJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ParticipanteJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ParticipanteJDialog dialog = new ParticipanteJDialog(new javax.swing.JFrame(), true);

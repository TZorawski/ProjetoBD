 ...
 */
public class FuncaoJDialog extends javax.swing.JDialog {
     ...
     */
    public FuncaoJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FuncaoJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FuncaoJDialog dialog = new FuncaoJDialog(new javax.swing.JFrame(), true);
